...
namespace WebAPI.Repositories
{
    public class ADO_Product
    {
        ...
        public static List<Product> DeleteProduct(long id)
        {
            DBConnection newConnection = new DBConnection();
            ...
            List<Product> newListProducts = ADO_Product.SelectProducts();
            return newListProducts;
        }

        public static List<Product> InsertProduct(Product product)
        {
            DBConnection newConnection = new DBConnection();
